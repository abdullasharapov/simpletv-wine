...
DISPLAY=:20.0 wine "/root/.wine/drive_c/simpleTV/tv.exe" -nooneinstance -execute "loadfile(m_simpleTV.MainScriptDir .. 'user/TVSources/core/x64/tvs_server.lua')('172.18.0.2','10000')" > /dev/null 2>&1 &
