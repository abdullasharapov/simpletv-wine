...
local trackFont = 'constantia'
local trackFontHeight = 40
local trackFontWeight = 70
local trackFontItalic = 0
local trackFontUnderline = 0
local stationFont = 'constantia'
local stationFontHeight = 30
local stationFontWeight = 70
local stationFontItalic = 0
local stationFontUnderline = 0

 local value = m_simpleTV.User.Radio.RadioTrackFontLayout6
 local t={}
 if value ~= nil  then
 ...
 value = m_simpleTV.User.Radio.RadioStationFontLayout6
 t={}
 if value ~= nil  then
    for w in string.gmatch(value, '[^,]+') do 
        t[#t+1]=w
...
local textColor = '0x' ..  m_simpleTV.User.Radio.RadioTextColorLayout6
local borderColor = '0x' ..  m_simpleTV.User.Radio.RadioBorderColorLayout6
local blur = m_simpleTV.User.Radio.RadioBlurBgLayout6
local scroll = m_simpleTV.User.Radio.RadioScrollTextLayout6

local numBreak = m_simpleTV.User.Radio.RadioTrackNumBreakLayout6
