...
local stationFontUnderline = 0
 ...
 local value = m_simpleTV.User.Radio.RadioTrackFontLayout4
 local t={}
 if value ~= nil  then
 ...
 value = m_simpleTV.User.Radio.RadioStationFontLayout4
 t={}
 if value ~= nil  then
    for w in string.gmatch(value, '[^,]+') do 
        t[#t+1]=w
...
local textColor = '0x' ..  m_simpleTV.User.Radio.RadioTextColorLayout4
local borderColor = '0x' ..  m_simpleTV.User.Radio.RadioBorderColorLayout4
local blur = m_simpleTV.User.Radio.RadioBlurBgLayout4
local scroll = m_simpleTV.User.Radio.RadioScrollTextLayout4

local numBreak = m_simpleTV.User.Radio.RadioTrackNumBreakLayout4
