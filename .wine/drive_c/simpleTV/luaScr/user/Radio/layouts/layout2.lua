...
local stationFontUnderline = 0
 ...
 local value = m_simpleTV.User.Radio.RadioTrackFontLayout2
 local t={}
 if value ~= nil  then
 ...
 value = m_simpleTV.User.Radio.RadioStationFontLayout2
 t={}
 if value ~= nil  then
    for w in string.gmatch(value, '[^,]+') do 
        t[#t+1]=w
...
local textColor = '0x' ..  m_simpleTV.User.Radio.RadioTextColorLayout2
local borderColor = '0x' ..  m_simpleTV.User.Radio.RadioBorderColorLayout2
local blur = m_simpleTV.User.Radio.RadioBlurBgLayout2
local scroll = m_simpleTV.User.Radio.RadioScrollTextLayout2
local numBreak = m_simpleTV.User.Radio.RadioTrackNumBreakLayout2
